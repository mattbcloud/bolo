...
(function() {
  var BaseWorld, ServerWorld, buildPacker, pack, ref,
  ...
  ref = require('../../struct'), pack = ref.pack, buildPacker = ref.buildPacker;

  ServerWorld = (function(superClass) {
    extend(ServerWorld, superClass);
