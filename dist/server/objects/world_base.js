...
export class WorldBase extends BoloObject {
    ...
    updateOwner() {
        ...
        if (this.owner) {
            ...
            console.log(`[BASE updateOwner VERIFY] Base idx=${this.idx}, readback via bracket: this['team']=${this['team']}`);
            console.log(`[BASE updateOwner VERIFY] Base idx=${this.idx}, readback via bracket: this['_team']=${this['_team']}`);
        }
