...
const textColorCache = new Map<number, string>();
 ...
 */
export function teamTextColor(team: number | null | undefined): string {
  if (team == null || team < 0 || team >= TEAM_COLORS.length) return NEUTRAL_TEXT_COLOR;
